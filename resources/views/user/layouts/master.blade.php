            ...
            <div class="col-lg-3 d-none d-lg-block">
                {{-- <div class="">
                    <a href="" class="text-decoration-none">
                        <span class="h-3 text-uppercase text-primary mt-5 bg-dark px-2">My Shop</span>
                    </a>
                </div> --}}
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            <div class="dropdown d-inline me-5">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item my-3" href="{{ route('user#accountPage') }}"><i class="fa-solid fa-user"></i> Account</a></li>
